...
public class AddToCartTest extends Astractclass {
	...
	public void ATC_01() {
		...
		if (driver.findElement(By.xpath("//a[contains(text(),'QUẦN SHORT M1SKK1061002 - GR - 34')]")).getText().contains(Tensp+" - " + mau + " - "+size)==true 
			    || 
			    driver.findElement(By.xpath("//body/div[@id='add-with-pop-up']//child::input")).getText().contains(Solg)==true
			    ||
			    
			     driver.findElement(By.xpath("//span[contains(text(),'238,500 đ')]")).getText().contains(Gia)==true)
